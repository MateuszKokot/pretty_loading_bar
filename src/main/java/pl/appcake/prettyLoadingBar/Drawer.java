...
public class Drawer implements DrawerOperations {
    ...
    public void renderBar(PrettyLoadingBar prettyLoadingBar) {
        ...
        if (allowDrawing) {
            ...
            if (prettyLoadingBar.getLabelPosition() == PrettyLoadingBar.LEFT)
                System.out.print(prettyLoadingBar.getLabel() + "\t");
            ...
            for (int i = 0; i < currentNumberOfSteps; i++) {
                System.out.print(prettyLoadingBar.getTheme().getCompletedStepChar());
            }
            ...
            if (prettyLoadingBar.getLabelPosition() == PrettyLoadingBar.RIGHT)
                System.out.print(prettyLoadingBar.getLabel() + "\t");
            ...
            // AFTER ALL JUMP TO NEXT LINE AND DON'T DRAW ANYMORE
            if (prettyLoadingBar.getTotalTaskCountToComplete() == prettyLoadingBar.getCompletedTasks()) {
                System.out.println();
                allowDrawing = false;
            }
        }
